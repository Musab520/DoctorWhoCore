...
{
    public partial class CreateSprocsFuncsViews : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var spSummariesEpisodesEnemies = @"Create Procedure spSummariesEpisodesEnemies
                        As
                  SELECT Top 3 EnemyId,COUNT(EnemyId) EnemyEpisodeCount 
                  FROM episodesEnemies
                  GROUP BY EnemyId order by EnemyEpisodeCount  desc;";
            var spSummariesEpisodesCompanions = @"Create Procedure spSummariesEpisodesCompanions
                  As
            ...
            migrationBuilder.Sql(spSummariesEpisodesEnemies);
            migrationBuilder.Sql(spSummariesEpisodesCompanions);
        ...
        {
            var spSummariesEpisodesEnemies = @"Drop Procedure spSummariesEpisodesEnemies";
            var spSummariesEpisodesCompanions = @"Drop Procedure spSummariesEpisodesCompanions";
